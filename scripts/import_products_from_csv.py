...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Validate or upsert product seed rows into public.products from a CSV template."
    )
    parser.add_argument(
        "--csv-path",
        default=str(DEFAULT_PRODUCT_IMPORT_CSV),
...
def main() -> int:
    args = parse_args()
    result = import_products_from_seed(
